...
const bankFilter = computed(() => {
  return [...new Set(loansStore.loans
      .filter(loan => loan.bank)
      .map(loan => loan.bank.name)
...
const handleRowsPerPageChange = (event) => {
  localStorage.setItem("rowsPerPageLoans", event.rows);
};
    ...
    >
      <template #header>
        <div class="flex justify-between">
          ...
          >
            <OfficeButton text="Nowy kredyt" btn-type="office-regular"/>
          </router-link>
      ...
      <template #expansion="slotProps">
        <div class=" p-3 justify-center">
          ...
          <div class="flex flex-col md:flex-row gap-4">
            <div class="basis-1/2 ">
              <Fieldset legend="Ogólne informacje" class="!mb-10">
  ...
  <Toolbar class="sticky-toolbar">
    ...
    <template #center>
      ...
      <OfficeIconButton
          ...
          :icon="
          loansStore.loadingLoans ? 'pi pi-spin pi-spinner' : 'pi pi-check-circle'
        "
          class="mr-2"
          :active="filter === 'PAID'"
