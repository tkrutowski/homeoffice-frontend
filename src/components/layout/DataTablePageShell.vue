<script setup lang="ts">
  /**
   * Wypełnia obszar `<main>` z App.vue (`flex-1 min-h-0`). Slot `#top` (np. Menubar) jest poza przewijanym
   * blokiem; przewija się wyłącznie slot domyślny (np. Panel + DataTable).
   */
  withDefaults(
    defineProps<{
