...
const getIcon = computed(() => {
  switch (props.componentType.name) {
    case 'PROCESSOR': return CpuChipIcon
    case 'MOTHERBOARD': return ServerIcon
    case 'COMPUTER_CASE': return ComputerDesktopIcon
    case 'RAM': return Square3Stack3DIcon
    case 'GRAPHICS_CARD': return PhotoIcon
    case 'DISK': return CircleStackIcon
    case 'POWER': return BoltIcon
    case 'DISPLAY': return DisplayIcon
    case 'KEYBOARD': return KeyIcon
    case 'MOUSE': return CursorArrowRippleIcon
    case 'SOUND_CARD': return SpeakerWaveIcon
    case 'USB': return UsersIcon
    case 'COOLER': return ArrowPathRoundedSquareIcon
