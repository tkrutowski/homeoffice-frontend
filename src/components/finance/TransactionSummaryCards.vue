...
<template>
  ...
  >
    <div
      class="rounded-xl border border-surface-200 bg-surface-0 p-4 dark:border-surface-700 dark:bg-surface-950"
    >
    ...
    >
      ...
      <p class="text-2xl font-bold tabular-nums" :class="incomeClass">
        +{{ UtilsService.formatCurrency(income) }}
      </p>
    </div>
