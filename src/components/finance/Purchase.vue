<script setup lang="ts">
  ...
  const calculateDeadline = async () => {
    ...
    await cardStore
      .getCardFromDb(purchase.value.idCard)
      .then((card: Card | null) => {
        if (card) {
          ...
          <div class="flex flex-column col-12 col-xl-6">
            ...
            <div class="flex flex-row">
              <div class="flex flex-column col-12">
                ...
                />
                <small class="p-error">{{ showErrorFirm() ? 'Pole jest wymagane.' : '&nbsp;' }}</small>
              </div>
            </div>
            ...
            <div class="flex-row flex grid">
              <div class="flex flex-column col-12 col-md-6">
                ...
                <InputNumber id="amount" v-model="purchase.amount" :min-fraction-digits="2" :max-fraction-digits="2" />
            ...
            <div class="flex-row flex grid">
              <div class="flex flex-column col-12">
                ...
                <Calendar id="date" v-model="purchase.paymentDeadline" show-icon date-format="yy-mm-dd" />
              </div>
            </div>
