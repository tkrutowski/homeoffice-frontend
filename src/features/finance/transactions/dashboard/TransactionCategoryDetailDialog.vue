<script setup lang="ts">
  ...
  import { parseTransactionAmount } from '@/features/finance/transactions/useBankTransactionFilters';
  import {
    buildAmountsByBucket,
    filterTransactionsByCategory,
    groupTransactionsByDate,
  } from '@/features/finance/transactions/transactionDashboardAggregation';
  import type { CategoryBreakdownItem, ChartGranularity } from '@/features/finance/transactions/dashboardTypes';
