<script setup lang="ts">
  ...
  import AddBankDialog from '@/features/finance/banks/AddBankDialog.vue';
  import {
    UserIcon,
    BuildingLibraryIcon,
    CalendarDaysIcon,
  ...
  const loanQuery = useLoanQuery(loanId, isEdit);
      ...
      <form class="mx-auto max-w-4xl" @submit.stop.prevent="saveLoan">
        ...
        >
          ...
          <div class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-stretch">
                      ...
                      >
                        ...
                        <Select
                          ...
                          :pt="ptSelectInField"
                          :options="banksQuery.data.value ?? []"
                          option-label="name"
                          placeholder="Wybierz bank"
                          :loading="banksQuery.isFetching.value"
                          @change="loan.bank = selectedBank ? selectedBank : null"
                        />
                      </div>
                      <OfficeIconButton
                        title="Dodaj bank"
                        :icon="banksQuery.isFetching.value ? 'pi pi-spin pi-spinner' : 'pi pi-plus'"
                        class="text-orange-500"
            ...
            <FormSectionCard title="Szczegóły kredytu" :icon="CalculatorIcon">
              <div class="flex flex-col gap-5">
