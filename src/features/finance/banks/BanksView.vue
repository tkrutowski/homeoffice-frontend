<script setup lang="ts">
  ...
  import { useDeleteBankMutation } from '@/features/finance/banks/queries/useBanksMutations';
  ...
  const toolbarLoading = computed(() => banksQuery.isFetching.value);
  ...
  <MainPageShell>
    ...
    <Panel class="my-3 mx-2">
      ...
      >
        <template #header>
          <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center justify-end gap-4">
              <div v-if="toolbarLoading" class="flex items-center">
        ...
        <template #empty>
          <p v-if="!toolbarLoading" class="text-red-500">Nie znaleziono banków...</p>
        </template>
